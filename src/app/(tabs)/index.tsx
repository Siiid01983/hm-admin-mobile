...
// HOME (Chat-First): the conversation list is the app's anchor. Open the app →
// your customers are right here. Tap a conversation to open its room, where the
// in-chat Approve/Reject booking actions live.
